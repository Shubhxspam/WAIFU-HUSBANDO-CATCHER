...
***I am An Open Source Waifu Catcher Bot...​Add Me in Your group.. And I will send Random Characters After.. every 100 messages in Group... Use /guess to.. Collect that Characters in Your Collection.. and see Collection by using /Harem... So add in Your groups and Collect Your harem***
        """
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("SOURCE", url=f'https://github.com/Shubhxspam/WAIFU-HUSBANDO-CATCHER')]
        ]
...
***/grab: To Grab the character (only works in group)***
***/fav: Add Your fav***
